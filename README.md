...
## Starter Code
The starter code in this repo provides a simple 3D viewer for tetrahedral mesh simulations.
...
Note: After cloning the repo locally, you may need to run `git submodule update --init --recursive` to update the Eigen submodule.
